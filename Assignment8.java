...
public class Assignment8 {
	...
	{ 
		...
		{ 
			...
			pw.println(rollno+"\t "+studentid+"\t "+studentname+"\t "+address+"\t "+Class+"\t "+marks); System.out.print("\nRecords added successfully !\n\nDo you want to add more records ? (y/n) : "); 
			s = br.readLine(); 
	...
	{ 
		...
		case "1" :System.out.print("Enter updated name : ");
			...
			pw.println(line[0]+"\t"+line[1]+"\t "+up_name+"\t"+line[3]+"\t"+line[4]+"\t"+line[5]); 
			flag=1; 
			break;
	...
	{ 
		Assignment8 call = new Assignment8(); 
		call.showMenu(); 
	} 
}
